...
def resnet50v2(pretrained=False, use_norm=False, **kwargs):
    """Constructs a ResNet-50v2 model.
    """
    model = ResNet(Bottleneck_v2, [3, 4, 6, 3], **kwargs)
    print('Loading pretrained Resnet-50v2 model')
    return model